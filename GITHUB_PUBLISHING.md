...
4. Create tag `v1.1.2` from the tested commit.
5. Create a GitHub release named `AR01V3 ESP-RC01 Gateway v1.1.2`.
6. Use `.github/releases/v1.1.2.md` as the release description.
